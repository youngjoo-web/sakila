...
<html>
	...
	<%
		...
		ArrayList<FilmCategoryAndFilmAndCategory> list = filmCategoryDao.selectFilmCategoryList(rowPerPage, beginRow);
		
		// 페이징 관련 로직 (lastPage, totalCount)
		int totalCount = 0;
		totalCount = filmCategoryDao.selectTotalCount(totalCount);
			...
			<div id="main">
				...
				<div>
					<table class="table table-striped" style="margin-top: 20px">
						...
						<tbody>
						<%
							for(FilmCategoryAndFilmAndCategory f : list){
						%>
								<tr>
